"""
Step 2: DA3 Depth Estimation + Camera Pose
===========================================
Conda env: rl_da3
...
def run_da3(frame_paths: list[str], device: str = "cuda:0") -> dict:
    ...
    Returns dict with numpy arrays: depth, extrinsics, intrinsics, conf.
    """
...
def main():
    parser = argparse.ArgumentParser(description="Step 2: DA3 depth + camera pose")
    ...
    print(f"[Step2] Found {len(frame_paths)} frames")
    ...
    print(f"[Step2] Saved DA3 output to {args.output}")
