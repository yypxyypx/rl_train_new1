...
class AttentionPool(nn.Module):
    ...
    def forward(self, x):
        ...
        # compute attention
        x = flash_attention(q, k, v, version=2)  # type: ignore
        x = x.reshape(b, 1, c)
...
class CLIPModel(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_path, transformer_additional_kwargs={}, **kwargs):
        ...
        # ensure keys are prefixed with "model." only once
