...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=6,
        help="the hunyuan variant is a guidance distilled model",
    )
            ...
            with accelerator.accumulate(transformer3d):
                ...
                if args.enable_text_encoder_in_dataloader:
                    ...
                    with torch.no_grad():
                        ...
                        text_inputs_2_ids = text_inputs_2.input_ids
                        prompt_embeds_2 = text_encoder_2(text_inputs_2_ids.to(accelerator.device), output_hidden_states=False).pooler_output
