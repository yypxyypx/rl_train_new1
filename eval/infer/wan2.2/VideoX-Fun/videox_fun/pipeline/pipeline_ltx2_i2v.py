# Modified from https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/ltx2/pipeline_ltx2_image2video.py
...
class LTX2I2VPipeline(DiffusionPipeline, FromSingleFileMixin):
    r"""
    ...
    def __call__(
        ...
        if output_type == "latent":
            ...
            audio = self.vocoder(generated_mel_spectrograms).cpu().float()
        ...
        return LTX2PipelineOutput(videos=video, audio=audio)