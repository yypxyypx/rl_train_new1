# Modified from https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/ltx2/pipeline_ltx2.py
...
class LTX2Pipeline(DiffusionPipeline, FromSingleFileMixin):
    r"""
