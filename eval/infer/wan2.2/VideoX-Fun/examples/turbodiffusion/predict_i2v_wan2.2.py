...
transformer_path        = "models/Personalized_Model/TurboWan2.2-I2V-A14B-low-720P.pth"
transformer_high_path   = "models/Personalized_Model/TurboWan2.2-I2V-A14B-high-720P.pth"
vae_path                = None
...
save_path           = "samples/turbowan-videos-i2v"

device = set_multi_gpus_devices(ulysses_degree, ring_degree)
config = OmegaConf.load(config_path)
boundary = config['transformer_additional_kwargs'].get('boundary', 0.900)

transformer = TurboWanTransformer3DModel.from_pretrained(
...
transformer_2 = TurboWanTransformer3DModel.from_pretrained(
